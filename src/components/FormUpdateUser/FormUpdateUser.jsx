...
const FormUpdateUser = ({
  ...
  return (
    <div className="container">
      {updateUser.map((el) => {
        return (
          <form key={el.id} className="form">
            <div className="form__title">{`${el.firstName} ${el.lastName}`}</div>
              ...
              <div className="row">
                ...
                <div className="col-75">
                  <input
                    ...
                    id="username"
                    name="username"
                    placeholder={`Your username ${el.username}`}
                  />
              ...
              <div className="row">
                ...
                <div className="col-75">
                  <input
                    ...
                    id="fname"
                    name="firstname"
                    placeholder={`Your name ${el.firstName}`}
                  />
              ...
              <div className="row">
                ...
                <div className="col-75">
                  <input
                    ...
                    id="lname"
                    name="lastname"
                    placeholder={`Your last name ${el.lastName}`}
                  />
              ...
              <div className="row">
                ...
                <div className="col-75">
                  <input
                    ...
                    id="email"
                    name="email"
                    placeholder={`Your email ${el.email}`}
                  />
